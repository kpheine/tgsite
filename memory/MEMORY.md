...
src/
  ...
  lib/uploads.ts         — image upload validation and filesystem writes
...
.env.example             — ADMIN_PATH, ADMIN_USERNAME, ADMIN_PASSWORD, SESSION_SECRET, HOST, PORT, ALLOWED_HOSTS, SESSION_COOKIE_SECURE, UPLOAD_MAX_IMAGE_BYTES, SMTP_USER, SMTP_PASS, CONTACT_TO
